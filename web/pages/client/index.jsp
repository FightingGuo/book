	...
	<script type="text/javascript">
		...
		//给加入购物车按钮绑上单机事件
			$("button.addToCart").click(function () {
				...
				// location.href="http://localhost:8080/book/cartServlet?actio=addItem&id="+bookId;

				//ajax请求添加商品到购物车
				$.getJSON("http://localhost:8080/book/cartServlet","action=ajaxAddItem&id="+bookId,function (data) {
					if (data.totalCount == 0) {
						$("#cartLastName").text("当前购物车为空")
					} else {
...
<body>
	...
	<div id="main">
		<div id="book">
			...
			<c:forEach begin="" items="${requestScope.page.items}" var="book">
			<div class="b_list">
				<div class="img_div">
